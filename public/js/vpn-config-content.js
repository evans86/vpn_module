...
(function (global) {
    ...
    function buildVpnActionToolbarHtml() {
        ...
        return (
            ...
            '<p class="text-xs text-gray-500 mb-3 sm:mb-4">Clash / Mihomo / Karing: вставьте скопированную ссылку как подписку — будут узлы и правила «без VPN» для доменов из списка.</p>' +
            '<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 auto-rows-fr">' +
