...
return [
    /*
    |--------------------------------------------------------------------------
    | Распределение по панелям (только интеллектуальный выбор)
    |--------------------------------------------------------------------------
    |
    | Выбор панели: score по статистике Marzban, активным пользователям и времени
    | последней активности. Кэш ниже ускоряет повторные выборы.
    |
    */
