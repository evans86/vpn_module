...
return [
    ...
    |
    | При мульти-провайдере эта стратегия применяется отдельно для каждого провайдера
    | (getOptimizedMarzbanPanelForProvider), т.е. распределение по-прежнему нужно.
    |
    */
