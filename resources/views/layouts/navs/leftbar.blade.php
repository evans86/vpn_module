        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{ route('admin.module.server-users.index') }}"
                   class="ai-icon {{ request()->routeIs('admin.module.server-users.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <span class="nav-text">Пользователи сервера</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('admin.module.telegram-users.index') }}"
                   class="ai-icon {{ request()->routeIs('admin.module.telegram-users.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                         stroke-linejoin="round" class="feather feather-users">
                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
            ...
            <li>
                <a href="{{ route('admin.module.server-monitoring.index') }}"
                   class="ai-icon {{ request()->routeIs('admin.module.server-monitoring.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <span class="nav-text">Статистика нагрузки</span>
                </a>
            </li>
{{--            <li>--}}
{{--                <a href="{{ route('admin.module.connection-limit-violations.index') }}"--}}
{{--                   class="ai-icon {{ request()->routeIs('admin.module.connection-limit-violations.*') ? 'active' : '' }}">--}}
{{--                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"--}}
{{--                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"--}}
{{--                         stroke-linejoin="round" class="feather feather-shield">--}}
{{--                        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>--}}
{{--                    </svg>--}}
{{--                    <span class="nav-text">Лимиты подключений</span>--}}
{{--                </a>--}}
{{--            </li>--}}
            <li>
