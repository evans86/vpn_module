                            ...
                            <div class="col-md-6">
                                ...
                                @if($key->packSalesman)
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <a href="{{ route('admin.module.pack.show', $key->packSalesman->pack) }}" class="text-primary">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <a href="{{ route('admin.module.salesman.show', $key->packSalesman->salesman) }}" class="text-primary">
                                ...
                                @if($key->keyActivateUser && $key->keyActivateUser->serverUser)
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <a href="{{ route('admin.server-users.show', $key->keyActivateUser->serverUser) }}" class="text-primary">
