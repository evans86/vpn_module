...
{{--                </li>--}}
                <li>
                    <a href="{{ \App\Helpers\UrlHelper::personalRoute('personal.activation-success') }}"
                       class="nav-link flex items-center p-3 rounded-lg {{ request()->routeIs('personal.activation-success') ? 'active' : '' }} tooltip">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="ml-3" id="activation-success-text">После активации ключа</span>
                        <span class="tooltip-text">Текст в боте после активации</span>
                    </a>
                </li>
                <li>
        ...
        <div class="absolute bottom-0 w-full p-4 border-t border-gray-200">
            <form action="{{ \App\Helpers\UrlHelper::personalRoute('personal.logout') }}" method="GET">
                @csrf
                <button type="submit"
        ...
        @if(session('impersonation_admin_id'))
            <div class="bg-amber-50 border-b border-amber-200 px-4 py-3">
                <div class="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
                    ...
                    <form action="{{ \App\Helpers\UrlHelper::personalRoute('personal.logout') }}" method="GET" class="inline">
                        @csrf
...
{{-- ЛК: полностью снимаем SW (failover на зеркала), чтобы не ломать POST-формы и навигацию --}}
<script>
(function () {
