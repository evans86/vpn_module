                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $salesman->telegram_id }}"
                                               readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               value="{{ $salesman->username ?? 'Не указан' }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="mb-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="form-group">
                                    <label>ID</label>
                                    <input type="text" class="form-control"
                                           value="{{ $salesman->module_bot_id ?? 'Не указан' }}" readonly>
                                </div>
                            </div>
                                            ...
                                            @foreach($salesman->packs as $pack)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($packSalesman)
                                                            <span
                                                                class="badge {{ $packSalesman->isPaid() ? 'badge-success' : 'badge-warning' }}">
