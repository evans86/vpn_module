        ...
        <x-admin.card>
            ...
            <x-slot name="tools">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <a href="{{ route('admin.module.salesman.impersonate', $salesman) }}"
                       ...
                       title="Откроется личный кабинет продавца на сайте конфигов (APP_CONFIG_PUBLIC_URL)">
                        <i class="fas fa-user-secret mr-2"></i> Открыть личный кабинет как продавец
                    </a>
                </div>
            </x-slot>
