    ...
    <div id="config-progress-bar" class="container mx-auto px-4 pt-4 max-w-6xl">
        <div class="bg-indigo-50 border border-indigo-200 rounded-xl p-4 flex items-center gap-4">
            ...
            <div id="config-progress-done-icon" class="flex-shrink-0 hidden">
                <svg class="h-6 w-6 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
            </div>
            <div class="flex-1 min-w-0">
                <p id="config-progress-text" class="text-sm font-medium text-indigo-800">Загрузка актуальных данных с серверов… Подождите.</p>
                <p class="text-xs text-indigo-600 mt-1">Ниже уже показаны сохранённые данные; блок обновится по завершении.</p>
    ...
    (function(){
        ...
        function runRefresh() {
            ...
            function tickProgress() {
                ...
                var pct = elapsed >= durationMs ? maxPct : Math.min(maxPct, (elapsed / durationMs) * maxPct);
