...
//                $this->sendMessage("✅ Бот успешно добавлен!\n\nТеперь вы можете купить пакет VPN-доступов.");
    ...
    protected function start(): void
    {
        try {
            ...
            $message = "👋 Добро пожаловать в систему управления VPN-доступами\n\n";
            ...
            $message .= "🔹 Автоматизацию - Ваш бот сам выдает доступы клиентам 24/7\n";
            $message .= "🔹 Гибкость - выбирайте тарифы, управляйте ценами и следите за балансом\n";
            $message .= "🔹 Высокий спрос - VPN нужен многим, а значит, клиентов будет достаточно!\n";
            $message .= "🔹 Простоту подключения - без сложных настроек, просто привяжите своего бота\n\n";
            $message .= "💼  Как начать?\n";
