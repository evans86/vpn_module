...
class SalesmanBotController extends AbstractTelegramBot
{
    ...
    protected function actionHelp(): void
    {
        ...
        $text .= "3. Скопируйте конфигурацию и следуйте инструкциям для подключения на различных устройствах, представленным ниже\n\n";
        $text .= "🔹 <b>Проверка статуса:</b>\n\n";
        $text .= "1. Нажмите '📊 Статус'\n";
        $text .= "2. Просмотрите информацию о вашем доступе и конфигурации\n\n";
        $text .= "📁 <b>Инструкции по настройке VPN BOT-T:</b>\n\n";
        $text .= "- <a href=\"ссылка\">Инструкция для Android</a> 📱\n";
