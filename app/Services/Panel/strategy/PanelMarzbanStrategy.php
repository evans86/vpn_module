...
class PanelMarzbanStrategy extends PanelMainStrategy implements PanelInterface
{
    ...
    {
        $this->marzbanService->updateConfigurationReality443($panel_id);
    }
    ...
    {
        $this->marzbanService->updateConfigurationRealityStealth($panel_id);
    }
    ...
    {
        $this->marzbanService->updateConfigurationMixedStealth($panel_id);
    }
